...
export default class LocationUpdatePage {
  pageTitle: ElementFinder = element(by.id('openCellarBookApp.location.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  nameInput: ElementFinder = element(by.css('input#location-name'));
  colorInput: ElementFinder = element(by.css('input#location-color'));
  iconInput: ElementFinder = element(by.css('input#file_icon'));
  orderNumberInput: ElementFinder = element(by.css('input#location-orderNumber'));
  deletedAtInput: ElementFinder = element(by.css('input#location-deletedAt'));
