...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.sm0x.tools.opencellarbook.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.sm0x.tools.opencellarbook.repository.UserRepository.USERS_BY_EMAIL_CACHE);
