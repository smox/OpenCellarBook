...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="openCellarBookApp.location.delete.question">
        <Translate contentKey="openCellarBookApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
